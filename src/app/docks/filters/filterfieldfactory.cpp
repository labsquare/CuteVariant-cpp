...
FilterFieldFactory::FilterFieldFactory()
{

}

AbstractFieldWidget *FilterFieldFactory::widget(const cvar::Field &field)
{
...
QList<Operator::Type> FilterFieldFactory::operatorsList(const cvar::Field &field)
{
